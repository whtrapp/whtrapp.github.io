...
let apiKey = '7c742b695b3243f3864123423232302'
    ...
    function fetchWeatherData() {
            ...
            .then(data => {
                ...
                fetch(`http://api.weatherapi.com/v1/astronomy.json?key=${apiKey}&q=${cityInput}&dt=${theDate}`)
                    .then(response => response.json())
                    .then(astrodata => {
                ...
                fetch(`http://api.weatherapi.com/v1/forecast.json?key=${apiKey}&q=${cityInput}&days=1&aqi=yes&alerts=no`)
                    .then(response => response.json())
                    .then(tomorrowdata => {
